...
export const News = ({news, ServicesData}) => {
          ...
          <div className="overflow-hidden">
            <div className="d-flex align-items-center justify-content-between flex-wrap">
              <div className="d-flex align-item-center flex-wrap">
                <h4 className="main-title channel-logo mt-5 mb-0" style={{fontSize: "26px"}}>{news}</h4>
              </div>
          ...
          <div className="swiper-container list-inline row p-0 m-0 " as="ul">
            ...
            >
              {ServicesData.map((service, index) => (
                <div key={index} className="swiper-slide swiper-slide-duplicate" style={{ width: "143.333px" }} data-swiper-slide-index="7" as="li">
                  <div className="ws-card" style={{ width: "100%", backgroundImage: `url("${service.image}")` }}>
                    ...
                    <div className="d-flex flex-column justify-content-between align-items-center w-100 ws-title">
                      <div className="text-center d-flex align-items-center justify-content-end flex-column ">
                        <a className="ws-card-title" href={service.course_url}><img src={service.logo} alt={service.teacher_name + " logosu"} style={{ width: "70%",  pointerEvents: "none"}} /></a> 
                        <div className="mt-auto">
                          <div className="ws-card-line"></div>
                          <div className="d-flex justify-content-center text-center w-100 px-3 mb-1">{service.title}</div>
                        </div>
                      </div>
                      <div className="d-flex flex-column align-items-stretch " style={{ width: "90%" }}>
                        ...
                        <a role="button" className="btn btn-outline-light overflow-hidden" href={service.course_url}>İncele</a>
                      </div>
                    </div>
                  </div>
                </div>
